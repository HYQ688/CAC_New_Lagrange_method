...
filename1 = 'linear_bdf2phi_e0.14726gamma=0.1S1=4Nx=128Ny=128';
...
figname1 = ['D:\paper\phase-field\CAC_Vesicles_surface_LagrangeMultiplier_SAV\fig\',filename,'_N2uv_a','.png'];
print(figname1,'-dpng', '-r300')


figure(2)
s=pcolor(xx,yy,p+0.00);
s.FaceColor='interp';
s.EdgeColor='interp';
colormap jet;
% colorbar;
...
figname2 = ['D:\paper\phase-field\CAC_Vesicles_surface_LagrangeMultiplier_SAV\fig\',filename,'_N2p_a','.png'];
