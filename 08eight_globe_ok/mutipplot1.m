...
% 
% % 在主图中创建小图
% pos1 = [0.05, 0.54, 0.4, 0.4]; % 位置和大小 [x, y, width, height]
...
% 
% % 在主图中创建小图
% pos1 = [0.16, 0.21, 0.4, 0.4]; % 位置和大小 [x, y, width, height]
% ax = axes('Position', pos1); % 创建小图区域
% % 使用 axes 创建小图
% % 修正：生成三维网格数据
% 
...
% 
% % 在主图中创建小图
% pos1 = [0.38, 0.15, 0.4, 0.4]; % 位置和大小 [x, y, width, height]
% ax = axes('Position', pos1); % 创建小图区域
% % 使用 axes 创建小图
% % 修正：生成三维网格数据
% 
...
% 
% % 在主图中创建小图
% pos1 = [0.62, 0.12, 0.4, 0.4]; % 位置和大小 [x, y, width, height]
% ax = axes('Position', pos1); % 创建小图区域
% % 使用 axes 创建小图
% % 修正：生成三维网格数据
% 
...
% 
% % 
% figname = ['D:\paper\phase-field\CAC_Vesicles_surface_LagrangeMultiplier_SAV\fig\',scheme2,'N3energy.png'];
...
% 保存图片
figname = fullfile('D:\paper\phase-field\CAC_Vesicles_surface_LagrangeMultiplier_SAV\fig\', [scheme2, 'N3energy.png']);
% print(figname, '-dpng', '-r300');
