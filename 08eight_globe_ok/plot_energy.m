...
plot(energy1(tmp:1:end,1),energy1(tmp:1:end,2),'g-','LineWidth',2.5);
hold on
plot(energy2(tmp:1:end,1),energy2(tmp:1:end,2),'b-','LineWidth',2.5);
h = legend('First scheme','Second scheme','box','off','interpreter','latex');
