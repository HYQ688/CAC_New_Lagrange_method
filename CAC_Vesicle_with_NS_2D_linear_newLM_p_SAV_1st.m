function [phi, U, u, v, p, Q, eta_2] = CAC_Vesicle_with_NS_2D_linear_newLM_p_SAV_1st(pde,domain,Nx,Ny,time,option)
...
% Initial energy
if 1 == option.energyflag
    calculate_energy1(out1,out2,t,phi0,u0,v0,U0,Q0); 
end
...
for nt = 1:nplot
    ...
    G1_u = rhs2 + u0./dt - diff_x(p0);  G1_v = rhs3 + v0./dt - diff_y(p0);
...
function [] = calculate_energy1(out1,out2,t,phi0,u,v,U,Q)
...
energy_modified = energy_phi + energy_part2 + rr + 1./2*(Q^2-1) ;
